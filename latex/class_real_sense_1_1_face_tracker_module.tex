...
\item 
\textbf{ Face\+Tracker\+Module} (int[$\,$] idx)
\item 
...
\subsubsection{Face\+Tracker\+Module()}
{\footnotesize\ttfamily Real\+Sense.\+Face\+Tracker\+Module.\+Face\+Tracker\+Module (\begin{DoxyParamCaption}\item[{int [$\,$]}]{idx }\end{DoxyParamCaption})}
...
\item 
Various/\textbf{ Face\+Tracker\+Module.\+cs}\end{DoxyCompactItemize}
