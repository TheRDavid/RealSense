\section{Real\+Sense.\+A\+U\+\_\+\+Brow\+Shift Class Reference}
...
\subsubsection{A\+U\+\_\+\+Brow\+Shift()}
...
Computes the percentage Value of Brow\+Shift in the current Frame over a set number of frames and prints its\textquotesingle{} debug-\/message to the \doxyref{Camera\+View}{p.}{class_real_sense_1_1_camera_view} when debug is enabled. 
...
\item 
Action\+Units/\textbf{ A\+U\+\_\+\+Brow\+Shift.\+cs}\end{DoxyCompactItemize}
