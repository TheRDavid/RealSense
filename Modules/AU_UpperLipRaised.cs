...
namespace RealSense
{
    ...
    class AU_UpperLipRaised : RSModule
    {
        ...
        private double[] upperLip_Distance = new double[4];
        ...
        public override void Work(Graphics g)
        {
            ...
            upperLip_Distance[0] = model.DifferenceNullCurrent(35, Model.AXIS.Y);
            upperLip_Distance[0] = model.DifferenceNullCurrent(36, Model.AXIS.Y);
            upperLip_Distance[0] = model.DifferenceNullCurrent(37, Model.AXIS.Y);
            upperLip_Distance[0] = model.DifferenceNullCurrent(39, Model.AXIS.Y);
